class ClientsController < ApplicationController
  ...
  def create
    ...
    #client VO
    @client = Client.new(params.require(:client).permit(:id, :name, :email, :password,:cpf, :street, :number, :neighborhood, :city, :state, :zip_code, :complement, :confirm_password, :gender))
    ...
    @client_object = ClientObject.new(nil,@client.name, @client.cpf, login, address, @client.gender)
  ...
  def update
    ...
    #VO
    @client_object = ClientObject.new(@client.id, nil, nil, nil,address)
