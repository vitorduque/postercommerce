...
* Configuration:
* Run postercommerce.sql to create tables and seed the database
* Modify dao_connection_datas.rb
* Modify the "require"s
* Run it
...
* Documentation is still being made -in portuguese- (see on "software specifications" folder) :D
